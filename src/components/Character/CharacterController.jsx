 ...
 *
 * This component manages the movement and animation state of the 3D character.
 * It handles keyboard input, camera positioning, and transitions between
 * animations like idle, walking, and running. It also integrates with the
 * Character component to provide physics-based control in a 3D scene.
 *
