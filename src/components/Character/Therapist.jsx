...
- Encouraging them to start journaling`;
    ...
    const history = entries
      .map(
        (entry, i) =>
          `${i + 1}. ${entry.date}: "${entry.title}" | Emotion: ${entry.emotion} | Description: "${entry.description}"`
      )
      .join("\n");
          ...
          <div className="relative min-w-[440px] max-w-[500px] font-sans">
            ...
            <div className="relative bg-gradient-to-br from-slate-900/95 via-slate-800/95 to-slate-900/95 backdrop-blur-2xl rounded-[2rem] p-6 shadow-2xl border border-white/10 overflow-hidden">
              ...
              <div className="absolute inset-0 opacity-30">
                ...
                <div
                  className="absolute bottom-10 left-10 w-24 h-24 bg-gradient-to-br from-violet-400/20 to-pink-400/20 rounded-full blur-xl animate-pulse"
                  style={{ animationDelay: "1s" }}
                ></div>
                <div
                  className="absolute top-1/2 left-1/2 w-40 h-40 bg-gradient-to-br from-cyan-400/10 to-blue-400/10 rounded-full blur-3xl animate-pulse"
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-2 mt-1">
                        ...
                        <p className="text-xs text-slate-400 m-0 font-medium">
                          AI Therapist • {getRecentJournalEntries().length}{" "}
                          insights ready
                        </p>
                      </div>
                    </div>
